...
//debug MetaStorm download popup
public class Page_Metastorm
{
...
//                        iframe_ele = driver.findElement(By.id("eFormContents"));
//                        driver.switchTo().frame(iframe_ele);
////                        driver.findElement(By.id("tmpTxtCF_ApplicationURN")).sendKeys("SPL7164000042");
...
////                        orgname = "Ubaldo";
////                        driver.findElement(By.xpath("//div[@dataFld='txtA_ApplicationURN' and text()='SPL7164000042']")).click();
...
//                driver.switchTo().frame(tableIframe);
//                Thread.sleep(3000);
            if((driver.findElements(By.xpath("//*[text()='New Application by test']"))).size() > 0 ) {
//                    driver.findElement(By.xpath("//*[text()='New Application by " + orgname + "']")).click();
                driver.findElement(By.xpath("//*[text()='New Application by test']")).click();
                Thread.sleep(5000);
            }else
            {
                driver.findElement(By.xpath("//img[@title='Previous page']")).click();
//                    driver.findElement(By.xpath("//*[text()='New Application by " + orgname + "']")).click();
            ...
            System.out.println("main parent window is :: " + currentWindow);
            System.out.println("1st  window URL is :: " + driver.getCurrentUrl());
            System.out.println("windows handle size is :: " + driver.getWindowHandles().size());
            for (String handle : driver.getWindowHandles()) {
                System.out.println("windows are :: " + handle);
                if (!(handle.equalsIgnoreCase(currentWindow))) {
                    System.out.println("2nd  window URL is :: " + driver.getCurrentUrl());
                    System.out.println("switching to second window :: " + handle);
                    Thread.sleep(1000);
//                    Set<String> newWindow = driver.getWindowHandles();

//                    System.out.println("window handle size inside 2nd window /////// :: " + newWindow.size());
                    Thread.sleep(6000);
//                    driver.manage().window().maximize();
...
//                            System.out.println("switching window is :: " + win);
...
//                    driver.switchTo().alert().dismiss();
                    System.out.println("ENTER TAB using ROBOT  ******************************************");
//                    driver.switchTo().
//                        new WebDriverWait(driver, 30).until(
//                                webDriver -> ((JavascriptExecutor) webDriver).executeScript("window.focus();"));
...
//                        rb.keyRelease(KeyEvent.VK_CONTROL);
                    System.out.println("number of windows are :: " + driver.getWindowHandles().size());
