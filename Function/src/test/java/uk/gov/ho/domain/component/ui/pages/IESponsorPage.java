...
//            applySponsorLicenceButton.click();
            wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.name("formSponsorHome:licence")))).click();
            Thread.sleep(3000);
...
//        driver.get(Configuration.get(PBS_SPONSOR_URL));
        try {
            openSponsorApp();
    ...
    public void retrieveEmailData()
    {
        ...
        try {
            ...
            Thread.sleep(3000);
            driver.findElement(By.name("sponsorpwdchange:password")).sendKeys(sponserPassword);
            driver.findElement(By.name("sponsorpwdchange:newpassword")).sendKeys("Password1!");
            driver.findElement(By.name("sponsorpwdchange:confirmnewpassword")).sendKeys("Password1!");
